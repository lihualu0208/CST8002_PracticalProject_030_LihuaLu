...
"""
CST8002 - Practical Project Part 03 & 04
Professor: Stanley Pieda
Due Date: 2025-11-20
Author: Lihua Lu

This module contains the menu system for user interaction with seabird records
with polymorphic record types and chart visualization features.
"""

import os
from business.seabird_service import SeabirdService
from presentation.chart_menu import ChartMenu
...
class MenuSystem:
    ...
    def __init__(self):
        """Initializes the menu system with seabird and chart services."""
        self.service = SeabirdService()
        self.chart_menu = ChartMenu(self.service)
    ...
    def display_menu(self):
        ...
        print("11. Chart Visualization")  # NEW FEATURE
        print("0. Exit")
        print("-" * 50)
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                choice = input("Enter your choice (0-11): ")  # Updated range
                ...
                elif choice == "11":  # NEW CHART VISUALIZATION FEATURE
                    self.chart_menu.run_chart_menu()
                
                else:
                    print("Invalid choice. Please try again.")
                
                if choice != "11" and choice != "0":  # Don't pause after chart menu
